...
class UNIQ_Library_project_test final : public JUCEApplicationBase
{
	const String getApplicationName() override { return "UNIQ_Library_project_test"; }
...
int main(const int argc, const char* argv[])
{
	...
	t.detach();
	JUCEApplicationBase::createInstance = []() -> JUCEApplicationBase* { return new UNIQ_Library_project_test(); };
#if defined(_WIN32)
